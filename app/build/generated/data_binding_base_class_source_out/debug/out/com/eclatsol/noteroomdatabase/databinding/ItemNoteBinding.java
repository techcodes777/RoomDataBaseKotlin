...
public final class ItemNoteBinding implements ViewBinding {
  ...
  private ItemNoteBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView deleteButton,
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoteBinding((ConstraintLayout) rootView, deleteButton, text);
    }
